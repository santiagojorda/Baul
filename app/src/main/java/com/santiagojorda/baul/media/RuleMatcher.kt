...
object RuleMatcher {
    ...
    fun matches(rule: RuleEntity, mediaRelativePath: String?): Boolean {
        ...
        // Case-insensitive: algunos dispositivos reportan distinta capitalización para la misma
        // carpeta física según el origen del escaneo (FUSE vs MediaProvider legacy), y con "=="
        // eso generaba una regla automática duplicada para la carpeta ya cubierta.
        return mediaRelativePath.equals(expected, ignoreCase = true)
    }
